    ...
    <>
      <div className="flex items-center gap-x-4 mb-6">
        <input
          ...
          className="border p-2 text-base bg-deadlock-city text-white border-zinc-800 focus:border-zinc-700 outline-none rounded w-80"
        />

      </div>
      <div className="bg-gray-800 border border-gray-800 shadow-lg shadow-emerald-800/40">
        ...
        {currentPlayers.length > 0 ? (
          ...
          <div className="text-zinc-500 py-10 text-center border  bg-deadlock-city">
            player not found
          </div>
        )}
